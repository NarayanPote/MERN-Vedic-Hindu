    ...
    return (
      <Aux>
                               ...
                               {/*} show={achieveDreams && achieveDreams.length !== 0 ? true : false}*/}
                                ...
                                onHide={() => this.setState({ isVertically: false })} closeButton */}
                                <Modal centered show={this.state.isVertically}  backdrop="static">
                                    <Modal.Header >
                                        <Modal.Title as="h5">Club Membership Fee</Modal.Title>
                                    </Modal.Header>
                                    <Modal.Body>
                                    ...
                                    <Col md={12}>
                                        ...
                                        <Form.Control readOnly defaultValue="Rs.1200/-" />
                                        </Form.Group>
                                    </Col>
                                    </form>
                                    </Modal.Body>
                                    <Modal.Footer>
                                        ...
                                        <Button variant="secondary" onClick={() => this.setState({ isVertically: false })} >Pay Now</Button>
                                        {/* <Button variant="primary" onClick={() => this.sweetAlertHandler({title: 'Alert !', type: 'success', text: 'Pla Make Payment in next seven days...!!'})}>Pay Letter</Button> */}
                                        <Button variant="primary" onClick={() => this.setState({ isVertically1: true, title: '@mdo' })}>Pay Later</Button>
                               ...
                               {/*  */}
                                ...
                                <Modal centered show={this.state.isVertically1} onHide={() => this.setState({ isVertically1: false })} backdrop="static">
                                    <Modal.Header closeButton>
                                        <Modal.Title as="h5">Message  {this.state.title}</Modal.Title>
                                    </Modal.Header>
                                    <Modal.Body>
                                    <h5>Pla Make Payment in next seven days...!</h5>
                                    </Modal.Body>
                                    <Modal.Footer>
                                        <Button variant="secondary" onClick={() => this.setState({ isVertically1: false })}>Close</Button>
                                        <NavLink to="/member/add-member"><Button variant="primary">Proceed</Button></NavLink>
                                    </Modal.Footer>
                                </Modal>
                                </div>
          ...
          <Col xl={4} md={12}>
            <Card className="bg-c-blue order-card">
              <Card.Body>
                ...
                <p className="m-b-0">
                  $5,032 <i className="feather icon-arrow-up m-l-10 m-r-10"></i>
                  $1,055 <i className="feather icon-arrow-down" />
                </p>
          ...
          <Col xl={4} md={12}>
            <Card className="bg-c-green order-card">
              <Card.Body>
                ...
                <p className="m-b-0">
                  $5,032{" "}
                  <i className="feather icon-arrow-down m-l-10 m-r-10"></i>
                  $1,055 <i className="feather icon-arrow-up" />
                </p>
