...
class EditDieties extends React.Component {
    ...
    onSubmit = (event) => {
		...
		axios.put('http://localhost:5000/api/adddieties/' + this.props.match.params.id, updateUser)
    ...
    getEmployeeById() {
        axios
          .get("http://localhost:5000/api/adddieties/" + this.props.match.params.id)
          .then((response) => {
            this.setState({
            ...
            <Aux>
                <Row>
                    <Col>
                        <Card>
                            <Card.Header>
                                <Card.Title as="h5">Edit Dieties</Card.Title>
                            </Card.Header>
                            <Card.Body>  
